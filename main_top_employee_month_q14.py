# -*- coding: utf-8 -*-
"""
Top Employee With Most Sales in a Month Main
========================================================

Main for reading records from the database to get the Top Employee With Most Sales in a Month
...
This script contains the following function
    ...
    * main - main function to perform read operation with the database to get the Top Employee With Most
             Sales in a Month
"""
# Standard imports
import logging
...
def main():
    """
    Main function to read records from the database to get the Top Employee With Most Sales in a Month
    ...
    try:
        ...
        db_aggregate.get_top_employee_sales(session, helper.ARGUMENTS.number)
