# -*- coding: utf-8 -*-
"""
Module to Get Top Tracks For each Genre Main
====================================================
...
This script contains the following function
    ...
    * main - main function to call appropriate functions to perform the read operation to Get Top Tracks For each Genre
"""
# Standard imports
import logging
...
def main():
    """
    Main function to read records from the database to Get Top Tracks For each Genre
    ...
    try:
        ...
        db_aggregate.get_top_tracks_for_genre(session, helper.ARGUMENTS.number)
