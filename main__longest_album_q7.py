# -*- coding: utf-8 -*-
"""
Read Operation Longest Albums Main
==========================================

Main Module for reading records in the chinook database to get the longest albums
...
This script contains the following function
    ...
    * main - main function to call appropriate functions to perform the read operation to get the longest albums
"""
# Standard imports
import logging
...
def main():
    """
    Main function to read records from the database to get the longest albums
    ...
    try:
        ...
        db_aggregate.get_longest_album(session, helper.ARGUMENTS.number)
