# -*- coding: utf-8 -*-
"""
Read Operation Top Artist Main
================================

Main Module for reading records in the chinook database to get the top artist
...
This script contains the following function
    ...
    * main - main function to call appropriate functions to perform the read operation to get the top artist
"""
# Standard imports
import logging
...
def main():
    ...
    try:
        ...
        db_aggregate.get_top_artist_tracks(session, helper.ARGUMENTS.number)
