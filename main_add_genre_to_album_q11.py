# -*- coding: utf-8 -*-
"""
Module to Add Genre Tags to Albums Main
========================================================

Main Module for reading records from the database to create a pandas dataframe to add Genre Tags to Albums
...
This script contains the following function
    ...
    * main - main function to add Genre Tags to Albums
"""
# Standard imports
import logging
...
def main():
    """
    Main function to to add Genre Tags to Albums
