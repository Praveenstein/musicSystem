# -*- coding: utf-8 -*-
"""
Number of Playlist an Album has been Added to Main
========================================================

Main for reading records from the database to get the number of playlist an album has been added to
...
This script contains the following function
    ...
    * main - main function to perform read operation with the database to get the number of playlist an album has
             been added to
"""
# Standard imports
import logging
...
def main():
    """
    Main function to read records from the database to get the number of playlist an album has been added to
    ...
    db_aggregate.get_number_of_playlist_album(session, helper.ARGUMENTS.number)
