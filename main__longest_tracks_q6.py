# -*- coding: utf-8 -*-
"""
Read Operation Longest Tracks Main
==========================================

Main Module for reading records in the chinook database to get the longest tracks
...
This script contains the following function
    ...
    * main - main function to call appropriate functions to perform the read operation to get the longest tracks
"""
# Standard imports
import logging
...
def main():
    """
    Main function to read records from the database to get the longest tracks
    ...
    try:
        ...
        db_aggregate.get_longest_tracks(session, helper.ARGUMENTS.number)
