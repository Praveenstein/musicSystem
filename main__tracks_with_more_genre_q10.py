# -*- coding: utf-8 -*-
"""
Module to Get Tracks with More than One Genre Main
===========================================================

Main Module for reading records from the database to Get Tracks with More than One Genre
...
This script contains the following function
    ...
    * main - main function to call appropriate functions to perform the read operation to Get Tracks with
             More than One Genre
"""
# Standard imports
import logging
...
def main():
    """
    Main function to read records from the database to Get Tracks with More than One Genre
